...
// By encapsulating all of our jQuery code to only run when the document is ready, the elements you're selecting will
// deﬁnitely be on the page when you access them
// If you're using jQuery in an actual ﬁle/script, don't forget the $(document).ready() wrapper!
$(document).ready()
...
// can also be written:
$(".menu").show( function(){   $(".menu").animate( {opacity: .5} ) })
